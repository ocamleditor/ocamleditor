...
let external_tasks = [
  ...
  3, (fun command -> {
    ...
    et_dir                   = "../tools";
    et_cmd                   = "ocaml";
    et_args                  = [true,"mkversion.ml"; true,"1.10.2"];
    et_phase                 = Some Before_clean;
    et_always_run_in_project = false;
    et_always_run_in_script  = false;
  });
...
let targets = [
  ...
  "Test", {
    ...
    num                  = 8;
    id                   = 21;
    output_name          = "dag_test";
    target_type          = Executable;
    compilation_bytecode = true;
    compilation_native   = false;
    toplevel_modules     = "dag_test.ml";
    package              = "str,unix";
    search_path          = "common oebuild"; (* -I *)
    required_libraries   = "common oebuildlib ";
    compiler_flags       = "-g";
    linker_flags         = "-g";
    thread               = true;
    vmthread             = false;
