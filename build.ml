...
let cmd_line_args = [
  `Uninstall, [
    "-prefix", String (fun x -> arg_5_prefix := Some x),
      (" Uninstallation prefix [default: see \"ocaml tools/uninstall.ml\"]");
  ...
  `Install, [
    "-prefix", String (fun x -> arg_2_prefix := Some x),
      (" Installation prefix [default: see \"ocaml tools/install.ml\"]");
