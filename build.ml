...
let targets = [
  ...
  "launcher", {
    ...
    other_objects        = "";
    external_tasks       = [3; 4];
    restrictions         = ["ENV(OCAMLEDITOR_MINGW<>1)"];
    dependencies         = [];
    show                 = true;
