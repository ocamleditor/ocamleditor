...
let external_tasks = [
  ...
  3, (fun command -> {
    ...
    et_dir                   = "../tools";
    et_cmd                   = "ocaml";
    et_args                  = [true,"mkversion.ml"; true,"1.9.0"];
    et_phase                 = Some Before_clean;
    et_always_run_in_project = false;
    et_always_run_in_script  = false;
  });
...
let targets = [
  ...
  "ocamleditor", {
    ...
    package              = "compiler-libs.common,dynlink,lablgtk2,str,xml-light";
