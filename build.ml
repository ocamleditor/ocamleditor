...
let targets = [
  ...
  "ocamleditor", {
    ...
    package              = "compiler-libs.common,dynlink,lablgtk2,str";
    search_path          = "+ocamldoc +xml-light gmisclib common icons otherwidgets oebuild "; (* -I *)
    required_libraries   = "odoc_info xml-light gmisclib common icons otherwidgets oebuildlib ocamleditor_lib";
  ...
  "ocamleditor-bytecode", {
    ...
    package              = "compiler-libs.common,dynlink,lablgtk2,str";
    search_path          = "+ocamldoc +xml-light gmisclib common icons otherwidgets oebuild "; (* -I *)
    required_libraries   = "odoc_info xml-light gmisclib common icons otherwidgets oebuildlib";
    compiler_flags       = "-w syxm -g";
    linker_flags         = "-g";
    thread               = true;
    vmthread             = false;
  ...
  "ocamleditor-msvc", {
    ...
    package              = "compiler-libs.common,dynlink,lablgtk2,str";
    search_path          = "+ocamldoc +xml-light gmisclib common icons otherwidgets oebuild "; (* -I *)
    required_libraries   = "resource.obj odoc_info xml-light gmisclib common icons otherwidgets oebuildlib ocamleditor_lib";
    compiler_flags       = "-w syxm -g";
    linker_flags         = "-g";
    thread               = true;
    vmthread             = false;
  ...
  "plugin-remote-bytecode", {
    ...
    required_libraries   = "";
    compiler_flags       = "-g";
    linker_flags         = "-g dllcurl-helper.dll curl.cma";
    thread               = false;
    vmthread             = false;
    pp                   = "";
    inline               = None;
