...
let cmd_line_args = [
  ...
  "-use-modified-gtkThread", Set arg_use_modified_gtkThread,
    " Set this flag if you have Lablgtk-2.14.2 or\n                           earlier for using the included modified\n                           version of gtkThread.ml to reduce CPU consumption [default: Not Set]";
]
...
let targets = [
  ...
  "oebuild", {
    ...
    search_path          = "common oebuild"; (* -I *)
    required_libraries   = "unix str threads common";
    compiler_flags       = "-w y";
    linker_flags         = "";
    thread               = true;
    vmthread             = false;
  ...
  "oeproc", {
    ...
    required_libraries   = "str unix threads";
    compiler_flags       = "-w s";
    linker_flags         = "";
    thread               = true;
    vmthread             = false;
  ...
  "gmisclib", {
    ...
    search_path          = "+lablgtk2 gmisclib"; (* -I *)
    required_libraries   = "";
    compiler_flags       = "-g";
    linker_flags         = "-g";
    thread               = false;
  ...
  "otherwidgets", {
    ...
    search_path          = "+lablgtk2 icons common otherwidgets"; (* -I *)
    required_libraries   = "";
  ...
  "ocamleditor-bytecode", {
    ...
    search_path          = "+compiler-libs +lablgtk2 +ocamldoc gmisclib common icons otherwidgets oebuild "; (* -I *)
    required_libraries   = "ocamlcommon unix str threads dynlink odoc_info lablgtk gtkThread.o xml-light gmisclib common icons otherwidgets oebuildlib";
  ...
  "ocamleditor", {
    ...
    library_install_dir  = ""; (* Relative to the Standard Library Directory *)
    other_objects        = "";
    external_tasks       = [5; 6; 7; 8];
    restrictions         = [];
    dependencies         = [4; 10; 7; 5; 6; 8; 9];
    show                 = true;
    installer_task       = Some 8;
  };
