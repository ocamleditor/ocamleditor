...
VIAddVersionKey "FileVersion" "1.7.4"
;Icon "pixmaps\oe.ico"
...
Section "OCamlEditor (required)"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\OCamlEditor" "DisplayVersion" "1.7.4"
