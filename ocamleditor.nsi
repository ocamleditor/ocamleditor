...
;	!include "MUI2.nsh"
Name "OCamlEditor"
OutFile "ocamleditor-1.10.2.exe"
...
VIAddVersionKey "FileVersion" "1.10.2"
...
Section "OCamlEditor (required)"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\OCamlEditor" "DisplayVersion" "1.10.2"
