...
;	!include "MUI2.nsh"
Name "OCamlEditor"
OutFile "OCamlEditor-1.10.1-Windows.exe"
...
VIAddVersionKey "FileVersion" "1.10.1"
...
Section "OCamlEditor (required)"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\OCamlEditor" "DisplayVersion" "1.10.1"
