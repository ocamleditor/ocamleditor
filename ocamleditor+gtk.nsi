...
;	!include "MUI2.nsh"
Name "OCamlEditor"
OutFile "ocamleditor-1.9.5-gtk.exe"
...
VIAddVersionKey "FileVersion" "1.9.5"
...
Section "OCamlEditor (required)"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\OCamlEditor" "DisplayVersion" "1.9.5"
