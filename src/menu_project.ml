...
let project ~browser ~group ~flags items =
  ...
  project_clean_default_target#set_image (Icons.create (Preferences.Icon.get_themed_icon Icons.clear_build_16))#coerce;
  ...
  project_compile_only#set_image (Icons.create (Preferences.Icon.get_themed_icon Icons.compile_all_16))#coerce;
  ...
  project_build#set_image (Icons.create (Preferences.Icon.get_themed_icon Icons.build_16))#coerce;
  ...
  project_run#set_image (Icons.create (Preferences.Icon.get_themed_icon Icons.start_16))#coerce;
  ...
  project_comp_file#set_image (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.compile_file_16) ())#coerce;
  ...
  (* Targets *)
  let project_targets = GMenu.image_menu_item ~image:(Icons.create (Preferences.Icon.get_themed_icon Icons.target_16))#coerce ~label:"Targets" ~packing:menu#add () in
  ...
  project_refresh#set_image (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.refresh16)(*~stock:`REFRESH*) ~icon_size:`MENU ())#coerce;
