...
class ['a] toolbar ~(messages : Messages.messages) ~(hmessages : Messages.messages) ~(editor : Editor.editor) () =
  ...
  let _                        = tool_new_file#set_icon_widget (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.new_file) ())#coerce in
  ...
  let _                        = tool_messages#set_icon_widget (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.paned_bottom_large) ())#coerce in
  ...
  let _                        = tool_hmessages#set_icon_widget (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.paned_right) ())#coerce in
  ...
  let _                        = tool_eval#set_icon_widget (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.toplevel) ())#coerce in
  ...
  let _                        = tool_back#set_image (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.go_back) ())#coerce in
  let tool_forward             = Gmisclib.Toolbar.menu_tool_button ~toolbar ~label:"Next Location" ~homogeneous:false () in
  let _                        = tool_forward#set_image (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.go_forward) ())#coerce in
  let tool_last_edit_loc       = GButton.tool_button ~label:"Last Edit Location" () in
  let _                        = tool_last_edit_loc#set_icon_widget (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.goto_last) ())#coerce in
  ...
  object (self)
    ...
    initializer
      ...
      tool_save#set_icon_widget (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.save_16) ())#coerce;
      toolbar#insert tool_save_all#as_tool_item;
      tool_save_all#set_image (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.save_all_16) ())#coerce;
      ...
      tool_find#set_icon_widget (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.search_again_16) ())#coerce;
      ...
      tool_compile_file#set_icon_widget (Icons.create (Preferences.Icon.get_themed_icon Icons.compile_file_16))#coerce;
      let _ = GButton.separator_tool_item ~packing:toolbar#insert () in
      toolbar#insert tool_targets;
      tool_targets#set_icon_widget (Icons.create (Preferences.Icon.get_themed_icon Icons.target_16))#coerce;
      (** Clean, Compile, Build, Run *)
      let _ = GButton.separator_tool_item ~packing:toolbar#insert () in
      toolbar#insert tool_clean#as_tool_item;
      tool_clean#set_image (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.clear_build_16) ())#coerce;
      toolbar#insert tool_compile#as_tool_item;
      tool_compile#set_image (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.compile_all_16) ())#coerce;
      tool_compile#misc#set_tooltip_text "Compile only";
      toolbar#insert tool_build#as_tool_item;
      tool_build#set_image (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.build_16) ())#coerce;
      tool_build#misc#set_tooltip_text "Build";
      toolbar#insert tool_run#as_tool_item;
      tool_run#set_image (GMisc.image ~icon_size:`MENU ~pixbuf:(Preferences.Icon.get_themed_icon Icons.start_16) ())#coerce;
      (** Location History *)
      let _ = GButton.separator_tool_item ~packing:toolbar#insert () in
      ...
      tool_close_file#set_icon_widget (GMisc.image ~pixbuf:(Preferences.Icon.get_themed_icon Icons.close_16) ())#coerce;
      ()
