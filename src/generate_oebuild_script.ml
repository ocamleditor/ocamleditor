...
module Util = struct
  ...
  let test () =
    pushd (".."//"..");
    let cmd = sprintf "ocaml %s" ("src"//"oebuild"//filename) in
    Printf.printf "Testing %s in %s ...\n  %s\n%!" filename Unix.(getcwd ()) cmd;
...
let create_script () =
  ...
  try
    ...
    output_string ochan "#use \"topfind\"\n";
    output_string ochan "#require \"str\"\n";
    output_string ochan "#require \"unix\"\n";
    output_string ochan "#thread\n";
    output_string ochan "#directory \"src\"\n";
    output_string ochan "#directory \"src/common\"\n";
    output_string ochan "#directory \"src/oebuild\"\n";
    output_string ochan "\n";
    output_string ochan "#mod_use \"argc.ml\"\n";
    output_string ochan "#mod_use \"shell.ml\"\n";
    output_string ochan "#mod_use \"ocaml_config.ml\"\n";
    output_string ochan "#mod_use \"app_config.ml\"\n";
    output_string ochan "#mod_use \"spawn.ml\"\n";
    output_string ochan "#mod_use \"task.ml\"\n";
    output_string ochan "#mod_use \"build_script_command.ml\"\n";
    output_string ochan "#mod_use \"oebuild_util.ml\"\n";
    output_string ochan "#mod_use \"oebuild_table.ml\"\n";
    output_string ochan "#mod_use \"oebuild_dag.ml\"\n";
    output_string ochan "#mod_use \"oebuild_dep.ml\"\n";
    output_string ochan "#mod_use \"oebuild_dep_dag.ml\"\n";
    output_string ochan "#mod_use \"oebuild_parallel.ml\"\n";
    output_string ochan "#mod_use \"oebuild.ml\"\n";
    output_string ochan "#mod_use \"build_script_util.ml\"\n";
